...
namespace LanguageLearner.Utilities
{
    public class Synthesize
    {
        ...
        public string VoiceServiceName(string locale)
        {
            string returnValue = string.Empty;
            switch (locale)
            {
                case "de-DE":
                    returnValue = "Microsoft Server Speech Text to Speech Voice (de-DE, Hedda)";
                    break;

                case "zh-CN":
                    returnValue = "Microsoft Server Speech Text to Speech Voice (zh-CN, HuihuiRUS)";
                    break;

                case "en-GB":
                    returnValue = "Microsoft Server Speech Text to Speech Voice (en-GB, Susan, Apollo)";
                    break;

                case "en-US":
                    returnValue = "Microsoft Server Speech Text to Speech Voice (en-US, ZiraRUS)";
                    break;

                case "fr-FR":
                    returnValue = "Microsoft Server Speech Text to Speech Voice (fr-FR, Julie, Apollo)";
                    break;

                case "it-IT":
                    returnValue = "Microsoft Server Speech Text to Speech Voice (it-IT, Cosimo, Apollo)";
                    break;

                case "es-ES":
                    returnValue = "Microsoft Server Speech Text to Speech Voice (es-ES, Laura, Apollo)";
                    break;
            }
